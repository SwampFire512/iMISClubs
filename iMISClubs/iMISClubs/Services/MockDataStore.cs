    ...
    public class MockDataStore : IDataStore<RosterMember>
    {
        ...
        public MockDataStore()
        {
                ...
                var mockItems = new List<RosterMember>
            {
                ...
                {
                    new MemberAlert{Id = Guid.NewGuid().ToString(), Description = "Allergic to peanuts", Type = MemberAlertType.Urgent},
                    new MemberAlert{Id = Guid.NewGuid().ToString(), Description = "Dylan does not get along with Trey", Type = MemberAlertType.Warning}
                }},
                new RosterMember { Id = "70909", FullName = "Adrienne Cole", Description="Adrienne", InstituteType = "School", InstituteTypeName = "Copper Heights Elementary", Status = CheckInStatus.New, ProfileImageResource = "iMISClubs.EmbeddedImages.person.png" , MemberAlerts = new Collection<MemberAlert>
                {
                ...
                new RosterMember { Id = "48642", FullName = "Kylie Ford", Description="Kylie", InstituteType = "School", InstituteTypeName = "Copper Heights Elementary", Status = CheckInStatus.CheckedIn, ProfileImageResource = "iMISClubs.EmbeddedImages.person.png", MemberAlerts = new Collection<MemberAlert>
                {
                    new MemberAlert{Id = Guid.NewGuid().ToString(), Description = "Allowed to leave on his own", Type = MemberAlertType.Info}
                }},
                new RosterMember { Id = "46868", FullName = "Fausto Guzman", Description="Fausto", InstituteType = "School", InstituteTypeName = "Copper Heights Elementary", Status = CheckInStatus.New, ProfileImageResource = "iMISClubs.EmbeddedImages.person.png", MemberAlerts = new Collection<MemberAlert>
                {
                    new MemberAlert{Id = Guid.NewGuid().ToString(), Description = "Allergic to peanuts", Type = MemberAlertType.Urgent},
                    new MemberAlert{Id = Guid.NewGuid().ToString(), Description = "Allergic to dairy", Type = MemberAlertType.Urgent},
                    new MemberAlert{Id = Guid.NewGuid().ToString(), Description = "Allergic to gluten", Type = MemberAlertType.Urgent},
